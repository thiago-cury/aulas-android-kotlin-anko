...
//        implementation "org.jetbrains.anko:anko:$anko_version"
        ...
        ma_bt_ok.setOnClickListener {
            ...
            if(ma_et_idade.text.toString().isEmpty()){
                ma_et_idade.setError(getString(R.string.ma_et_idade_erro))
                return@setOnClickListener
            }

            val nome = ma_et_nome.text.toString()
            val idade = ma_et_idade.text.toString().toInt()
...
//            startActivity<Tela1>("pessoa" to p)
        }
    }
}
